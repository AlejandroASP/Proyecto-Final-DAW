...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2024 a las 13:22:04
...
INSERT INTO `cart` (`id`, `user_id`, `precio_total`, `fecha_de_compra`, `cantidad`) VALUES
(15, NULL, 0.00, '2024-05-16 08:25:22', 0),
(16, NULL, 0.00, '2024-05-16 08:25:30', 0),
(17, NULL, 0.00, '2024-05-16 08:26:03', 0),
(18, NULL, 0.00, '2024-05-16 08:26:20', 0),
(19, NULL, 0.00, '2024-05-16 08:26:42', 0),
(20, NULL, 0.00, '2024-05-16 08:26:46', 0),
(21, NULL, 0.00, '2024-05-16 08:29:47', 0),
(22, NULL, 0.00, '2024-05-16 08:30:02', 0),
(23, NULL, 0.00, '2024-05-16 08:34:07', 0),
(24, NULL, 0.00, '2024-05-16 08:37:13', 0),
(25, NULL, 0.00, '2024-05-16 08:41:01', 0),
(26, NULL, 0.00, '2024-05-16 08:41:12', 0);
...
(19, 'Arma 3', 3.00, '2013-09-12', 'Combate realista en un enorme mundo abierto militar. Gran cantidad de contenido en solitario y multijugador, más de 20 vehículos y 40 armas e infinitas posibilidades de creación de contenido. El mejor juego militar para PC. Auténtico, diverso, abierto... Con Arma 3 vas a vivir la guerra.', 4, 'https://products.eneba.games/resized-products/ZnCbfaV_350x200_1x-0.jpg'),
...
(35, 'Wolfenstein The New Order', 3.00, '2014-05-20', 'Wolfenstein®: The New OrderTM revitaliza la serie que creó el género de los shooters en primera persona. MachineGames, un estudio compuesto por un veterano grupo de desarrolladores muy laureados por su labor creando juegos impulsados por la trama, han sido los encargados de desarrollar Wolfenstein, que ofrece una elaborada narrativa repleta de acción, aventura y combate en primera persona.', 2, 'https://cdn1.epicgames.com/salesEvent/salesEvent/EGS_WolfensteinTheNewOrder_MachineGames_S2_1200x1600-0f70ad56e210812c26a9dde1a8143a58'),
...
(37, 'Superhot', 3.00, '2016-02-25', 'En SUPERHOT se desdibujan los límites entre estrategia precavida y caos desatado, creando un shooter en primera persona donde el tiempo solo se mueve si tú lo haces. Sin barras de salud que se regeneren. Ni alijos de municiones convenientemente situados. Solo estás tú, superado en número y armamento, aunque podrás recoger las armas de los enemigos abatidos, disparando, dando tajos y maniobrando en medio de un aluvión de balas a cámara lenta.', 2, 'https://i.3djuegos.com/juegos/11266/superhot/fotos/ficha/superhot-5169339.jpg'),
(38, 'Deep Rock Galactic Survivor', 3.00, '2024-04-30', 'Gray Zone Warfare es un juego de disparos táctico en 1.ª persona. Únete a una empresa militar privada y explora un gran mundo abierto en un multijugador masivo con modos PvEvP y PvE. Diseña estrategias y sobrevive contra enemigos humanos y de IA mientras descubres los misterios de la isla de Lamang.', 3, 'https://hardzone.es/app/uploads-hardzone.es/2024/02/deep-rock-galactic-survivor.jpg'),
...
(42, 'Rust', 3.00, '2018-02-08', 'El único objetivo en Rust es sobrevivir. Todo quiere que mueras - la vida silvestre de la isla y otros habitantes, el medio ambiente, otros sobrevivientes. Haz lo que sea necesario para pasar otra noche.', 3, 'https://red92com.nyc3.cdn.digitaloceanspaces.com/adjuntos/galerias/000/047/0000047038.jpg'),
(43, 'Dayz', 3.00, '2018-12-13', '¿Cuánto podrás sobrevivir en un mundo posapocalíptico? Es una tierra plagada de zombis infectados donde compites por recursos escasos. ¿Colaborarás con desconocidos y permaneceréis juntos? ¿O irás de lobo solitario para evitar traiciones? Esto es DayZ. Esta es tu historia.', 3, 'https://i.3djuegos.com/juegos/9098/day_z/fotos/ficha/day_z-4874304.jpg'),
(44, 'Project Zomboid', 3.00, '2013-11-08', 'Project Zomboid is the ultimate in zombie survival. Alone or in MP: you loot, build, craft, fight, farm and fish in a struggle to survive. A hardcore RPG skillset, a vast map, massively customisable sandbox and a cute tutorial raccoon await the unwary. So how will you die? All it takes is a bite..', 3, 'https://blizzstoreperu.com/cdn/shop/products/maxresdefault_a2a501b4-33f5-4bd0-81c8-7ee78d577b96.jpg?v=1657912185'),
(45, 'Subnautica Below Zero', 3.00, '2018-01-23', 'Desciende a las profundidades de un mundo submarino alienígena lleno de belleza y peligros. Crea equipamiento, pilota submarinos, terraforma el terreno, y burla los peligros para explorar exhuberantes arrecifes de coral, volcanes, sistemas de cuevas y más - Todo mientras intentas sobrevivir.', 3, 'https://uvejuegos.com/img/caratulas/66141/764152_front.jpg'),
(46, 'Valheim', 3.00, '2021-02-02', 'Un brutal juego de supervivencia y exploración multijugador, ambientado en un purgatorio generado de forma procedural e inspirado en la cultura vikinga. ¡Lucha, construye y conquista tu viaje en una saga digna de la bendición de Odin!', 3, 'https://gaming-cdn.com/images/products/7119/orig/valheim-pc-mac-juego-steam-cover.jpg?v=1706800610'),
(47, 'V Rising', 3.00, '2022-05-12', 'Despierta siendo un vampiro. Sal en busca de sangre para recuperar tus fuerzas y evade la abrasadora luz solar para sobrevivir. Alza tu castillo y progresa en un mundo abierto lleno de misterios que cambia constantemente. Gana aliados en línea y conquista las tierras de los vivos.', 3, 'https://www.mundodeportivo.com/alfabeta/hero/2022/05/v-rising-portada.jpg?width=768&aspect_ratio=16:9&format=nowebp'),
(48, 'Sons of The Forest', 3.00, '2024-02-22', 'Enviado a buscar a un multimillonario desaparecido en una isla remota, te encuentras en un paisaje infernal infestado de caníbales. Crea, construye y lucha para sobrevivir, solo o con amigos, en este aterrador simulador de terror de supervivencia de mundo abierto.', 3, 'https://e00-marca.uecdn.es/assets/multimedia/imagenes/2023/03/01/16776930494987.jpg'),
